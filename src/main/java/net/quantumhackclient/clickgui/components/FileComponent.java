...
import net.quantumhackclient.clickgui.screens.SelectFileScreen;
import net.quantumhackclient.settings.FileSetting;
...
public final class FileComponent extends Component
{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		TextRenderer fr = QuantumHackClient.MC.textRenderer;
		...
		QuantumHackClient.MC.setScreen(
			new SelectFileScreen(QuantumHackClient.MC.currentScreen, setting));
	}
