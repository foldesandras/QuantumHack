...
import net.quantumhackclient.clickgui.screens.EditBlockScreen;
...
public final class BlockComponent extends Component
{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		if(mouseButton == 0)
		{
			Screen currentScreen = QuantumHackClient.MC.currentScreen;
			EditBlockScreen editScreen =
				new EditBlockScreen(currentScreen, setting);
			QuantumHackClient.MC.setScreen(editScreen);
