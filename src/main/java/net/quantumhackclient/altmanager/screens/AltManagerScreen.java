...
import net.quantumhackclient.altmanager.*;
import net.quantumhackclient.util.ListWidget;
import net.quantumhackclient.util.MultiProcessingUtils;
...
public final class AltManagerScreen extends Screen
{
	...
	private void pressImportAlts()
	{
		try
		{
			Process process = MultiProcessingUtils.startProcessWithIO(
				...
				QuantumHackClient.INSTANCE.getWurstFolder().toString());
	...
	{
		// translate
		String translated = QuantumHackClient.INSTANCE
