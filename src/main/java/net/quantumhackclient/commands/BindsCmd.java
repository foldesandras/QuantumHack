...
public final class BindsCmd extends Command
{
	...
	private void add(String[] args) throws CmdException
	{
		...
		QUANTUM_HACK.getKeybinds().add(key, commands);
	...
	private void remove(String[] args) throws CmdException
	{
		...
		String commands = QUANTUM_HACK.getKeybinds().getCommands(key);
		if(commands == null)
			throw new CmdError("Nothing to remove.");
		
		QUANTUM_HACK.getKeybinds().remove(key);
	...
	private void list(String[] args) throws CmdException
	{
		...
		List<Keybind> binds = QUANTUM_HACK.getKeybinds().getAllKeybinds();
	...
	{
		QUANTUM_HACK.getKeybinds().removeAll();
		ChatUtils.message("All keybinds removed.");
	}
	
	private void reset()
	{
		QUANTUM_HACK.getKeybinds().setKeybinds(KeybindList.DEFAULT_KEYBINDS);
	...
	private void loadProfile(String[] args) throws CmdException
	{
		...
		try
		{
			QUANTUM_HACK.getKeybinds().loadProfile(name);
	...
	private void saveProfile(String[] args) throws CmdException
	{
		...
		try
		{
			QUANTUM_HACK.getKeybinds().saveProfile(name);
	...
	private void listProfiles(String[] args) throws CmdException
	{
		...
		ArrayList<Path> files = QUANTUM_HACK.getKeybinds().listProfiles();
		int page = parsePage(args);
