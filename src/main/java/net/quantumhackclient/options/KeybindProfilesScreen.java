...
public final class KeybindProfilesScreen extends Screen
{
	...
	public void init()
	{
		listGui = new ListGui(client, this,
			QuantumHackClient.INSTANCE.getKeybinds().listProfiles());
	...
	private void newProfile(String name)
	{
		...
		try
		{
			QuantumHackClient.INSTANCE.getKeybinds().saveProfile(name);
	...
	private void loadSelected()
	{
		...
		try
		{
			QuantumHackClient.INSTANCE.getKeybinds().loadProfile(fileName);
			openPrevScreen();
