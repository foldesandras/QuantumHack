...
import net.quantumhackclient.other_features.ZoomOtf;
...
public class ZoomManagerScreen extends Screen implements PressAKeyCallback
{
	...
	{
		ZoomOtf zoom = QuantumHackClient.INSTANCE.getOtfs().zoomOtf;
		CheckboxSetting scroll = zoom.getScrollSetting();
	...
	{
		QuantumHackClient.INSTANCE.getOtfs().zoomOtf.setBoundKey(key);
