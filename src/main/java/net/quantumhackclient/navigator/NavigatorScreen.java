...
public abstract class NavigatorScreen extends Screen
{
	...
	{
		QuantumHackClient.INSTANCE.getGui().updateColors();
		float[] bgColor = QuantumHackClient.INSTANCE.getGui().getBgColor();
		float opacity = QuantumHackClient.INSTANCE.getGui().getOpacity();
