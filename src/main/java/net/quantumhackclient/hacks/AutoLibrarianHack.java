...
import net.quantumhackclient.hacks.autolibrarian.BookOffer;
import net.quantumhackclient.hacks.autolibrarian.UpdateBooksSetting;
...
import net.quantumhackclient.settings.FacingSetting;
...
import net.quantumhackclient.util.*;
import net.quantumhackclient.util.BlockBreaker.BlockBreakingParams;
import net.quantumhackclient.util.BlockPlacer.BlockPlacingParams;
	...
	implements UpdateListener, RenderListener
{
	...
	private void breakJobSite()
	{
		...
		// equip tool
		QUANTUM_HACK.getHax().autoToolHack.equipBestTool(jobSite, false, true,
