...
import net.quantumhackclient.hacks.treebot.Tree;
import net.quantumhackclient.hacks.treebot.TreeBotUtils;
	...
	implements UpdateListener, RenderListener
{
	...
	private class TreeFinder extends TreeBotPathFinder
	{
		public TreeFinder()
		{
			super(BlockPos.ofFloored(QuantumHackClient.MC.player.getPos()));
		}
