...
import net.quantumhackclient.hacks.autofish.AutoFishDebugDraw;
import net.quantumhackclient.hacks.autofish.AutoFishRodSelector;
import net.quantumhackclient.hacks.autofish.FishingSpotManager;
import net.quantumhackclient.hacks.autofish.ShallowWaterWarningCheckbox;
	...
	implements UpdateListener, PacketInputListener, RenderListener
{
	...
	protected void onEnable()
	{
		...
		QUANTUM_HACK.getHax().antiAfkHack.setEnabled(false);
