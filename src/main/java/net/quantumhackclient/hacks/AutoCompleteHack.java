...
import net.quantumhackclient.hacks.autocomplete.MessageCompleter;
import net.quantumhackclient.hacks.autocomplete.ModelSettings;
import net.quantumhackclient.hacks.autocomplete.OpenAiMessageCompleter;
import net.quantumhackclient.hacks.autocomplete.SuggestionHandler;
