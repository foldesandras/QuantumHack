	...
	implements UpdateListener, RenderListener
{
	...
	protected void onEnable()
	{
		...
		QUANTUM_HACK.getHax().instantBunkerHack.setEnabled(false);
	...
	{
		HackList hax = QUANTUM_HACK.getHax();
	...
	private class WalkForwardTask extends Task
	{
		...
		public void run()
		{
			...
			QUANTUM_HACK.getRotationFaker().faceVectorClientIgnorePitch(vec);
	...
	private void placeBlockSimple(BlockPos pos)
	{
		...
		// face block
		QUANTUM_HACK.getRotationFaker().faceVectorPacket(hitVec);
