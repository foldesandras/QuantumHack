...
import net.quantumhackclient.clickgui.screens.EditBlockListScreen;
import net.quantumhackclient.events.GetAmbientOcclusionLightLevelListener;
import net.quantumhackclient.events.RenderBlockEntityListener;
import net.quantumhackclient.events.SetOpaqueCubeListener;
import net.quantumhackclient.events.ShouldDrawSideListener;
import net.quantumhackclient.events.UpdateListener;
import net.quantumhackclient.hack.Hack;
import net.quantumhackclient.mixinterface.ISimpleOption;
import net.quantumhackclient.settings.BlockListSetting;
	...
	ShouldDrawSideListener, RenderBlockEntityListener
{
	...
	protected void onDisable()
	{
		...
		// reset gamma
		FullbrightHack fullbright = QUANTUM_HACK.getHax().fullbrightHack;
