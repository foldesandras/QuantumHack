...
import net.quantumhackclient.events.MouseUpdateListener;
import net.quantumhackclient.events.UpdateListener;
import net.quantumhackclient.hack.Hack;
import net.quantumhackclient.settings.AimAtSetting;
	...
	implements UpdateListener, MouseUpdateListener
{
	...
	protected void onEnable()
	{
		...
		QUANTUM_HACK.getHax().autoFishHack.setEnabled(false);
	...
	public void onUpdate()
	{
		...
		QUANTUM_HACK.getHax().autoSwordHack.setSlot(target);
