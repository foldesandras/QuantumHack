...
import net.quantumhackclient.settings.EspBoxSizeSetting;
import net.quantumhackclient.settings.EspStyleSetting;
import net.quantumhackclient.settings.EspStyleSetting.EspStyle;
import net.quantumhackclient.settings.filterlists.EntityFilterList;
import net.quantumhackclient.settings.filters.FilterInvisibleSetting;
import net.quantumhackclient.settings.filters.FilterSleepingSetting;
	...
	CameraTransformViewBobbingListener, RenderListener
{
		...
		RegionPos region)
	{
		...
		for(PlayerEntity e : players)
		{
			...
			// set color
			if(QUANTUM_HACK.getFriends().contains(e.getEntityName()))
