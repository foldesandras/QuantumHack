...
import net.quantumhackclient.hacks.templatetool.Area;
import net.quantumhackclient.hacks.templatetool.ChooseNameScreen;
import net.quantumhackclient.hacks.templatetool.Step;
import net.quantumhackclient.hacks.templatetool.Template;
	...
	implements UpdateListener, RenderListener, GUIRenderListener
{
	...
	public void onEnable()
	{
		...
		QUANTUM_HACK.getHax().autoBuildHack.setEnabled(false);
		QUANTUM_HACK.getHax().bowAimbotHack.setEnabled(false);
