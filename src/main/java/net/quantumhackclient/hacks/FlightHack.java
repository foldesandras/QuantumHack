...
import net.quantumhackclient.events.IsPlayerInWaterListener;
	...
	implements UpdateListener, IsPlayerInWaterListener, AirStrafingSpeedListener
{
	...
	protected void onEnable()
	{
		...
		QUANTUM_HACK.getHax().creativeFlightHack.setEnabled(false);
		QUANTUM_HACK.getHax().jetpackHack.setEnabled(false);
