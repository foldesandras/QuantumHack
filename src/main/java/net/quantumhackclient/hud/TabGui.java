...
import net.quantumhackclient.other_features.TabGuiOtf;
...
public final class TabGui implements KeyPressListener
{
	...
	private final TabGuiOtf tabGuiOtf =
		QuantumHackClient.INSTANCE.getOtfs().tabGuiOtf;
	...
	public TabGui()
	{
		QuantumHackClient.INSTANCE.getEventManager().add(KeyPressListener.class,
			this);
		...
		features.addAll(QuantumHackClient.INSTANCE.getHax().getAllHax());
		features.addAll(QuantumHackClient.INSTANCE.getCmds().getAllCmds());
		features.addAll(QuantumHackClient.INSTANCE.getOtfs().getAllOtfs());
	...
	public void render(DrawContext context, float partialTicks)
	{
		...
		ClickGui gui = QuantumHackClient.INSTANCE.getGui();
		...
		matrixStack.push();
		Window sr = QuantumHackClient.MC.getWindow();
		...
		if(tabOpened)
		{
			...
			for(int i = 0; i < tab.features.size(); i++)
			{
				...
				context.drawText(QuantumHackClient.MC.textRenderer, fName, 2,
	...
	private static final class Tab
	{
		...
		private void onEnter()
		{
			...
			TooManyHaxHack tooManyHax =
				QuantumHackClient.INSTANCE.getHax().tooManyHaxHack;
