 ...
 */
package net.quantumhackclient.other_feature;
...
import net.quantumhackclient.other_features.*;
...
public final class OtfList
{
	...
	public final QuantumHackLogoOtf wurstLogoOtf = new QuantumHackLogoOtf();
