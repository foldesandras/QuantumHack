 ...
 */
package net.quantumhackclient.keybinds;
...
public final class KeybindProcessor implements KeyPressListener
{
	...
	public void onKeyPress(KeyPressEvent event)
	{
		...
		if(InputUtil.isKeyPressed(QuantumHackClient.MC.getWindow().getHandle(),
			GLFW.GLFW_KEY_F3))
			return;
		
		Screen screen = QuantumHackClient.MC.currentScreen;
